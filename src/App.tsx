...
export default function App() {
  ...
  if (authLoading) {
    return (
      <div className="flex items-center justify-center w-full h-screen bg-[#0A0A0A] text-[#E0E0E0]">
        <div className="flex flex-col items-center gap-3">
          <RefreshCw className="h-5 w-5 animate-spin text-blue-500" />
          <p className="text-[10px] font-mono uppercase tracking-widest text-white/40">Securing Clinical Sandbox...</p>
        </div>
      </div>
    );
  }
  ...
  if (!user) {
    return (
      <div className="flex items-center justify-center w-full h-screen bg-[#0A0A0A] text-[#E0E0E0] p-4 font-sans select-none overflow-y-auto">
        <div className="max-w-md w-full bg-[#111111]/80 border border-white/10 rounded-2xl p-6 md:p-8 shadow-2xl flex flex-col backdrop-blur-md relative overflow-hidden">
          ...
          <div className="text-center mb-6 relative z-10 animate-fade-in">
            ...
            <p className="mt-2.5 text-xs font-medium uppercase tracking-[0.2em] text-white/50 italic font-serif">
              Academic Clinical Synthesis
            </p>
            <p className="mt-2 text-[10px] font-sans font-semibold uppercase tracking-widest text-blue-400">
          ...
          <div className="space-y-4 mb-6 text-center relative z-10">
            ...
            <div className="grid grid-cols-1 gap-2 text-left text-[11px] text-white/60">
              <div className="flex items-start gap-2.5 bg-white/5 p-2.5 rounded-lg border border-white/5">
                ...
                <div>
                  <span className="font-semibold text-white">Private Dynamic History</span>: Secure record parsing using your private Firestore sandbox documents.
                </div>
              </div>
              <div className="flex items-start gap-2.5 bg-white/5 p-2.5 rounded-lg border border-white/5">
                <BookOpen className="w-4 h-4 text-blue-400 flex-shrink-0 mt-0.5" />
                <div>
                  <span className="font-semibold text-white">Clinical Evaluation Frameworks</span>: Synthesis guided by classic client-caregiver trust & psychological lense theory.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 pt-4 border-t border-white/5 text-center">
            ...
            <p className="font-serif italic text-xs text-white font-medium">Aswad Paradox</p>
            <p className="text-[8px] font-sans font-bold uppercase tracking-widest text-blue-400 leading-none mt-1">
              Founder, EllA AI
            </p>
          </div>
        </div>
  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-screen bg-[#0A0A0A] text-[#E0E0E0] overflow-hidden font-sans select-none">
      ...
      `}>
        ...
        <div className="grid grid-cols-3 border-b border-white/10 mb-4 flex-shrink-0">
          <button
            onClick={() => setActiveTab("chat")}
            className={`pb-2 text-[10px] font-bold uppercase tracking-widest transition-all cursor-pointer text-center ${
              activeTab === "chat"
        ...
        <div className="flex-1 overflow-y-auto space-y-3 pr-1 scrollbar-none">
          {activeTab === "chat" && (
            <div className="space-y-3 animate-fade-in">
              <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                <p className="text-[10px] font-bold text-white/30 uppercase tracking-widest mb-1 select-none flex items-center gap-1.5">
          ...
          {activeTab === "frameworks" && (
            <div className="space-y-3 animate-fade-in">
              <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                <p className="text-[10px] font-bold text-white/30 uppercase tracking-widest mb-1 flex items-center gap-1.5 select-none">
              ...
              <div className="space-y-2">
                <div className="p-3 bg-[#111] border border-white/5 rounded-xl">
                  <h4 className="text-[11px] font-semibold text-white/90">Attachment Theory (Bowlby)</h4>
                  <p className="text-[10px] text-white/40 mt-0.5 leading-relaxed">
                    Traces relational security, avoidant patterns, and caregiver trust dependencies.
                  </p>
                </div>
                <div className="p-3 bg-[#111] border border-white/5 rounded-xl">
                  <h4 className="text-[11px] font-semibold text-white/90">Cognitive Distortions (CBT)</h4>
                  <p className="text-[10px] text-white/40 mt-0.5 leading-relaxed">
                    Surfaces catastrophizing, emotional reasoning, and polarized 'all-or-nothing' loops.
                  </p>
                </div>
                <div className="p-3 bg-[#111] border border-white/5 rounded-xl">
                  <h4 className="text-[11px] font-semibold text-white/90">Ego Defenses (Vaillant)</h4>
                  <p className="text-[10px] text-white/40 mt-0.5 leading-relaxed">
                    Observes defense structures: intellectualization and passive suppression.
                  </p>
                </div>
              </div>
            </div>
          ...
          {activeTab === "crisis" && (
            <div className="space-y-3 animate-fade-in">
              <div className="bg-rose-500/5 border border-rose-500/20 p-3 rounded-lg">
                <p className="text-[10px] font-bold text-rose-400 uppercase tracking-widest mb-1 flex items-center gap-1.5 select-none font-sans">
              ...
              <div className="space-y-2">
                <div className="p-3 bg-[#111] border border-white/5 rounded-xl flex flex-col gap-0.5">
                  <div className="flex justify-between items-center">
                    <span className="text-[11px] font-semibold text-white">United States Hotline</span>
                    <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-rose-500/10 text-rose-400">988</span>
                  </div>
                  <p className="text-[10px] text-white/40 leading-relaxed">Confidential support active 24/7.</p>
                </div>
                <div className="p-3 bg-[#111] border border-white/5 rounded-xl flex flex-col gap-0.5">
                  <div className="flex justify-between items-center">
                    <span className="text-[11px] font-semibold text-white">Crisis Text Line</span>
                    <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-rose-500/10 text-rose-400">HOME to 741741</span>
                  </div>
                </div>
                <div className="p-3 bg-[#111] border border-white/5 rounded-xl flex flex-col gap-0.5">
                  <div className="flex justify-between items-center">
                    <span className="text-[11px] font-semibold text-white">Clinical Directory</span>
                    <a
        ...
        {/* Creator Showcase */}
        <div className="mt-auto pt-2 border-t border-white/5 flex flex-col gap-1 flex-shrink-0">
          <p className="text-[8px] font-bold text-white/30 uppercase tracking-widest select-none font-sans">
            Architect & Owner
          </p>
          <div className="relative group overflow-hidden rounded-lg bg-white/5 border border-white/10 p-2 flex flex-col transition-all hover:bg-white/10">
        ...
        <div className="pt-2 border-t border-white/5 flex flex-col gap-2.5 flex-shrink-0">
          {authLoading ? (
            <div className="flex items-center gap-1.5 text-white/40 text-[9px] py-1">
            ...
            <div className="flex items-center gap-2.5">
              <img
                ...
                alt="User avatar"
                className="w-7 h-7 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center font-bold text-white text-[10px] shadow-md shadow-blue-500/10"
                referrerPolicy="no-referrer"
              />
              <div className="min-w-0">
                <p className="text-xs font-bold text-white leading-tight truncate">{user.displayName || "Patient"}</p>
                <button
                  onClick={handleSignOut}
                  className="text-[9px] text-white/40 hover:text-white uppercase tracking-wider font-mono block text-left transition-colors cursor-pointer"
                >
                  Logout session
                </button>
              </div>
            ...
            <button
              onClick={handleSignIn}
              className="w-full flex items-center justify-center gap-1.5 bg-blue-600 hover:bg-blue-500 text-white font-bold text-[9px] py-1.5 px-3 rounded-lg transition-all uppercase tracking-wider shadow-md active:scale-95 cursor-pointer"
            >
      ...
      <main className="flex-1 flex flex-col relative bg-[#0A0A0A] h-full overflow-hidden">
        ...
        <header className="h-14 flex-shrink-0 flex items-center justify-between px-5 md:px-6 border-b border-white/5 bg-[#0A0A0A] z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-[10px] font-bold uppercase tracking-wider text-blue-500 hover:text-blue-400 transition-colors cursor-pointer"
            >
              New Session
            </button>
          </div>
        ...
        {/* Chat History Panel */}
        <div className="flex-1 p-4 md:p-6 space-y-6 overflow-y-auto bg-[#0A0A0A] scrollbar-thin">
              ...
              if (isUser) {
                return (
                  <motion.div
                    ...
                    className="max-w-2xl"
                  >
                    <p className="text-[9px] uppercase tracking-widest text-white/30 font-bold mb-2 select-none">
                      {new Date(msg.timestamp).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })} — Patient
                    </p>
                    <p className="text-base md:text-lg font-light text-white leading-relaxed tracking-tight select-text">
                      "{msg.text}"
                    </p>
                  </motion.div>
                );
                ...
                return (
                  ...
                  >
                    <p className="text-[9px] uppercase tracking-widest text-blue-400 font-bold mb-2 text-right select-none">
                      {new Date(msg.timestamp).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })} — EllA AI
                    </p>
                    <div className="bg-[#111111] border border-white/10 p-4 md:p-5 rounded-2xl shadow-xl relative">
                      <p className="text-sm md:text-base font-serif italic text-white/90 leading-relaxed select-text whitespace-pre-wrap font-light">
                        {msg.text}
                      </p>
                      <div className="absolute -left-2 top-6 w-4 h-4 bg-[#111111] border-l border-t border-white/10 rotate-[-45deg] z-0 hidden md:block"></div>
                    </div>
                  </motion.div>
                );
              }
            ...
            {isProcessing && (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] uppercase tracking-widest text-white/25 font-bold select-none">
        ...
        {/* User Input Area */}
        <div className="p-4 md:p-5 border-t border-white/5 bg-[#0A0A0A] flex-shrink-0">
          <div className="relative max-w-2xl mx-auto group">
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 md:py-3.5 md:px-5 pr-24 text-sm font-medium text-white placeholder-white/20 focus:outline-none focus:border-blue-500/40 focus:bg-white/10 transition-all disabled:opacity-50"
            />
            <div className="absolute right-2 top-1/2 -translate-y-1/2 flex gap-2">
              <button
                onClick={() => sendMessage()}
                disabled={!inputText.trim() || isProcessing}
                className="px-3 py-1.5 bg-blue-600 rounded-lg text-[10px] font-bold text-white hover:bg-blue-500 disabled:bg-white/5 disabled:text-white/20 transition-all uppercase tracking-wider active:scale-[0.97] cursor-pointer"
              >
                SEND
              </button>
            </div>
          </div>
          <p className="text-center mt-3 text-[9px] text-white/20 font-medium uppercase tracking-[0.15em] select-none">
